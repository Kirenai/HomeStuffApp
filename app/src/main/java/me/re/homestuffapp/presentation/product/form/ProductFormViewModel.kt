...
import me.re.homestuffapp.presentation.product.form.ProductFormEvent.DescriptionChanged
import me.re.homestuffapp.presentation.product.form.ProductFormEvent.NameChanged
import me.re.homestuffapp.presentation.product.form.ProductFormEvent.SaveProduct
import javax.inject.Inject

@HiltViewModel
class ProductFormViewModel @Inject constructor(
    private val saveProduct: me.re.homestuffapp.domain.usecases.SaveProduct
) : ViewModel() {
    ...
    private fun saveNourishment(categoryId: Long) {
        ...
        viewModelScope.launch {
            ...
            println("Product saved: ${productState.name}, ${productState.description}")
        }
    }
}